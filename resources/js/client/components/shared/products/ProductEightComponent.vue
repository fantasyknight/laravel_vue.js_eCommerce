<template>
    <div
        class="product-default inner-quickview inner-icon inner-icon-inline inner-btn"
    >
        <figure>
            <div
            ...
            <div class="btn-icon-group">
                ...
                <router-link
                    to="/pages/wishlist"
                    class="btn-icon-wish text-primary btn-icon"
