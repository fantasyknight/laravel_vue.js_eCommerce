<template>
    <main class="main">
        ...
        <div
            class="container skeleton-body skel-shop-products shop-off-canvas"
            :class="{loaded: loaded}"
        >
            ...
            <div class="row">
                        ...
                        >
                            <nav class="toolbox toolbox-sticky sticky-header">
                                <div class="toolbox-left">
                                    <a
                                        href="#"
                                        class="sidebar-toggle d-inline-flex"
                ...
                <aside class="sidebar-shop col-lg-3 order-lg-first mobile-sidebar position-fixed">
