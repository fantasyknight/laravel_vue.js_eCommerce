        ...
        <div class="container skeleton-body skel-shop-products" :class="{loaded: loaded}">
            ...
            <div class="row">
                <div class="col-lg-9">
                    ...
                    >
                        <div class="row">
                            <div class="pb-5 pb-md-0 col-md-5 col-lg-5 offset-1">
                                <h3 class="mb-2 ls-10">
                                    Electronic
                                    <br />Deals
                                </h3>
                            ...
                            <div class="col-md-4 offset-md-0 offset-1">
                                <div class="coupon-sale-content">
                                    <h4
                                        class="m-b-2 coupon-sale-text bg-white ls-10 text-transform-none"
                                    >Exclusive COUPON</h4>
                    ...
                    <div
                        class="info-box with-icon px-1 skel-hide"
