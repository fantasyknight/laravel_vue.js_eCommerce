    ...
    <main class="main">
        <div class="container skeleton-body skel-shop-products">
            ...
            <div class="product-single-container">
                <div class="row">
                    <div class="col-md-5">
                        <div class="product-single-gallery position-relative">
                    ...
                    <div class="col-md-7" sticky-container>
                        <div class="sticky-sidebar" v-sticky sticky-offset="{ top: 69 }">
                                            ...
                                            <ul class="config-size-list">
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <a
                                                            href="#"
                                                            :style="'background-color: ' + term.text"
                ...
                <div class="row skel-hide">
                    <div class="widget widget-info col-lg-6 pb-4 pb-md-0">
                        <ul class="promote">
                            <li>
                    ...
                    <div
                        class="product-single-share col-lg-6 align-items-start justify-content-lg-end"
                    >
