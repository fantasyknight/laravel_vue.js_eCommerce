<template>
    <main class="main">
        <div class="container">
            ...
            <div class="product-single-container product-single-extended product-page">
                <div class="container skeleton-body skel-shop-products">
                    <div class="product-single-gallery">
                        <div class="skel-pro skel-magnifier-extended"></div>
                    ...
                    <div class="skel-pro skel-extended-detail"></div>
                    <div class="product-single-details">
                        <div class="product-single-header">
                            <div class="row">
                                ...
                                <div
                                    class="col-lg-3 product-single-share pb-4 pb-lg-0 justify-content-lg-end"
                                >
                                    ...
                                    <div class="product-nav position-relative top-0 ml-5">
                                        
                                    </div>
                                    <product-nav-component class="position-relative top-0 ml-5" :prev-product="prevProduct" :next-product="nextProduct"></product-nav-component>
                                </div>
                            </div>
                        ...
                        <div
                            class="product-filters-container d-flex flex-wrap align-items-center justify-content-xl-end mb-0 pt-4 border-bottom-0"
                        >
                            ...
                            ></div>
                            <div
                                class="product-action mb-2 d-flex align-items-center flex-wrap"
                                v-if="
                        ...
                        <div
                            class="price-box text-lg-right mb-2 mt-1"
                            v-if="product.type == 'variable' && showPrice"
                        >
                            <del
                                class="old-price"
                                v-if="
                ...
                <div class="tab-content">
                    ...
                    >
                        <div class="product-desc-content">
                            ...
                            <p class="mb-0" v-for="attr in product.attributes" :key="attr.id">
                                {{ attr.name }}: &nbsp;&nbsp;{{
                                termNames(attr)
                                }}
                            </p>
