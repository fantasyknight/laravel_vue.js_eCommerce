<template>
    <main class="main">
        <div class="container skeleton-body skel-shop-products sidebar-product">
                    ...
                    <div class="product-single-container product-single-default">
                        <div class="row">
                            <div class="col-md-6 product-single-gallery">
                                ...
                                <div
                                    class="prod-thumbnail owl-dots skel-hide"
...
import ProductSidebarTwoComponent from "./shared/ProductSidebarTwoComponent";
...
export default {
    ...
    methods: {
        ...
        openGallery: function () {
            ...
            let children = activeDot.parentElement.parentElement.children;
            let i;
