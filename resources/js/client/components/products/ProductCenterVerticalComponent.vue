    ...
    <main class="main">
        <div class="container skeleton-body skel-shop-products">
            <product-breadcrumb-component
                ...
                :name="product.name"
            ></product-breadcrumb-component>
            <div class="product-single-container product-center-vertical">
                <div class="row">
                    <div class="col-lg-3">
                        ...
                        <div class="product-single-details skel-hide">
                            ...
                            >
                                <div class="product-ratings">
                                    <span
										...
										"
                                    ></span>
                                    <span class="tooltiptext tooltip-top">{{ product.average_rating.toFixed(2) }}</span>
                                </div>

                                <a
                                    href="#"
                                    class="rating-link text-truncate"
                            ...
                            <div class="product-single-share">
                                ...
                                <div class="social-icons vertical mr-2">
                                    <a
                                        href="#"
                    ...
                    <div
                        ...
                        :class="loaded? 'd-lg-flex' : 'd-block'"
                    >
                        <div class="skel-pro skel-vertical skel-padding-128"></div>
                        ...
                        <div
                            class="prod-thumbnail owl-dots d-lg-block order-lg-first skel-hide vertical-thumbs"
                    ...
                    <div class="col-lg-3">
                        <div class="skel-pro skel-detail"></div>
                        <div class="product-single-details skel-hide mb-3">
                            <div
                            ...
                            <div
								...
								"
                            >
                                <div class="product-qty-container mb-2">
                                    <label class="font1 text-uppercase mr-3 mb-0">Qty:</label>
            ...
            <div
                class="products-section pt-0"
                v-if="relatedProducts.length > 0 && this.loaded"
            >
            ...
            <div
                class="products-section pt-0"
                v-if="upsells.length > 0 && this.loaded"
            >
