<template>
    <main class="main">
        <div class="container">
            ...
            <div
                class="product-single-container product-single-grid skeleton-body skel-shop-products"
            >
                <div class="row">
                    <div class="col-lg-8 product-single-gallery">
                        <div class="skel-pro skel-magnifier-grid"></div>
                        ...
                        <div class="row skel-hide">
                            ...
                            <div class="col-sm-6 product-item" v-if="product.media.length == 0">
                                <img
                                    v-lazy="
										$root.getUrl(
            ...
            <div class="skel-pro skel-tab"></div>
