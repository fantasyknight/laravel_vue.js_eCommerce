...
@section('page-content')
    @include('admin.common.breadcrumb', ['current_page' => 'Post Replies', 'paths' => ['home' => '/dashboard', 'Posts' => '/posts']])
                    ...
                    <div class="card-body">
                        <div class="datatables-header-footer-wrapper">
                            ...
                            <div class="table-responsive">
                                <table class="table table-ecommerce-simple table-striped mb-0" id="datatable-ecommerce-list" style="min-width: 950px">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>@sortablelink('post.title', 'Post Title')</th>
                                        ...
                                        @if($comments->isNotEmpty())
                                            @foreach($comments as $comment)
                                                <tr>
                                                    ...
                                                    <td data-column="In Response To" data-post-id="{{ $comment->post_id }}" class="response-to"><a href="{{ url('admin/posts/' . $comment->post_id . '/edit') }}"><strong>{{ $comment->post->title }}</strong></a></td>
                                                    <td data-column="Post Title">{{ $comment->created_at }}</td>    
                                                    ...
                                                    <td class="actions" data-column="Actions">
                                                        ...
                                                        <a href="{{ url('admin/posts/comments/' . $comment->id . '/edit') }}" class="on-default edit-row"><i class="fas fa-pencil-alt"></i></a>
...
@section('page-js')
    <script src="{{ asset('server/js/comments/posts/list.min.js') }}"></script>
@endsection