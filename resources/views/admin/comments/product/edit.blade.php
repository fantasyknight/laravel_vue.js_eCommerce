...
@section('page-content')
    @include('admin.common.breadcrumb', ['current_page' => 'Edit Review', 'paths' => ['home' => '/dashboard', 'products' => '/products', 'reviews' => '/products/comments']])

    <form class="ecommerce-form " action="{{ url('/admin/products/comments/' . $comment->id) }}" method="post">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3-5 col-xl-4-5">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-5 col-xl-3 control-label text-lg-right pt-2 mt-1 mb-0">Rating</label>
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="number" class="form-control form-control-modern" name="rating" value="{{ $comment->rating }}" min="0" max="5" />
                                    </div>
                                </div>
                                <div class="form-group row align-items-center">
        ...
        <div class="row action-buttons">
            <div class="col-6 col-md-auto">
                <button type="submit" class="submit-button btn btn-primary btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-loading-text="Loading...">
                    <i class="bx bx-save text-4 mr-2"></i> Save Review
                </button>
            </div>
            <div class="col-6 col-md-auto px-md-0">
                <a href="{{ url('/admin/products/comments') }}" class="cancel-button btn btn-light btn-px-4 py-3 border font-weight-semibold text-color-dark line-height-1 d-flex h-100 align-items-center">Back</a>
            </div>
            ...
            <div class="col-6 col-md-auto ml-md-auto mt-3 mt-md-0">
                <a href="#" class="delete-button btn btn-danger btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-id="{{ $comment->id }}">
                    <i class="bx bx-trash text-4 mr-2"></i> Delete Review
                </a>
            </div>
        </div>
    </form>
...
@section('page-js')
    <script src="{{ asset('server/js/comments/products/edit.min.js') }}"></script>
@endsection