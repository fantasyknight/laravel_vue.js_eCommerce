...
@section('page-content')
    @include('admin.common.breadcrumb', ['current_page' => 'Cash on delivery Edit', 'paths' => ['home' => '/dashboard', 'eCommerce' => '/ecommerce', 'settings' => '/ecommerce/settings']])

    <!-- start: page -->
    <form class="ecommerce-form " action="{{ url('admin/ecommerce/settings/payment/3') }}" method="post">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-2-5 col-xl-1-5">
                                ...
                                <h2 class="card-big-info-title">Cash on delivery</h2>
                                <p class="card-big-info-desc">Add cash on delivery info with all details and necessary information.</p>
                            </div>
