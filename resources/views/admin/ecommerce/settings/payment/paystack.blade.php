...
@section('page-content')
    @include('admin.common.breadcrumb', ['current_page' => 'Paystack Edit', 'paths' => ['home' => '/dashboard', 'eCommerce' => '/ecommerce', 'settings' => '/ecommerce/settings']])

    <!-- start: page -->
    <form class="ecommerce-form " action="{{ url('admin/ecommerce/settings/payment/10') }}" method="post">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-2-5 col-xl-1-5">
                                ...
                                <h2 class="card-big-info-title">Paystack</h2>
                                <p class="card-big-info-desc">Add paystack info with all details and necessary information.</p>
                            </div>
                            <div class="col-lg-3-5 col-xl-4-5">
                                ...
                                <div class="form-group row align-items-center">
                                    <label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Secret ID</label>
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="text" class="form-control form-control-modern" name="public_key" @if(isset($public_key)) value="{{ $public_key }}" @endif required />
                                    </div>
                                </div>
                            </div>
                        </div>
