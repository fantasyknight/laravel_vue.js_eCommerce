...
@section('page-content')
    @include('admin.common.breadcrumb', ['current_page' => 'Paypal Edit', 'paths' => ['home' => '/dashboard', 'eCommerce' => '/ecommerce', 'settings' => '/ecommerce/settings']])

    <!-- start: page -->
    <form class="ecommerce-form " action="{{ url('admin/ecommerce/settings/payment/2') }}" method="post">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-2-5 col-xl-1-5">
                                ...
                                <h2 class="card-big-info-title">Paypal</h2>
                                <p class="card-big-info-desc">Add paypal info with all details and necessary information.</p>
                            </div>
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-lg-7 col-xl-6 d-flex">
                                        ...
                                        <div class="radio-custom radio-primary ml-5 mb-0">
                                            <input id="live" name="environment" type="radio" value="production" @if(isset($environment) && $environment == 'production') checked @endif>
                                            <label for="live">Live</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center">
                                    <label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Paypal Email</label>
                                    <div class="col-lg-7 col-xl-6">
                                        <input type="text" class="form-control form-control-modern" name="paypal_email" @if(isset($paypal_email)) value="{{ $paypal_email }}" @endif required />
                                    </div>
                                </div>
                            </div>
                        </div>
