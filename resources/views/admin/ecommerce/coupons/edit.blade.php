...
@section('page-content')
    @include('admin.common.breadcrumb', ['current_page' => 'Edit Coupon', 'paths' => ['home' => '/dashboard', 'ecommerce' => '/ecommerce', 'coupons' => '/ecommerce/coupons']])

    <form class="ecommerce-form " action="{{ url('admin/ecommerce/coupons/' . $coupon->id) }}" method="post">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col">
                                ...
                                <div class="tab-content" id="tabContent">
                                    <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="text" maxlength="50" class="form-control form-control-modern" name="code" value="{{ $coupon->code }}" required />
                                            </div>
                                        </div>
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <select class="form-control form-control-modern" name="discount_type" id="discount-type">
                                                    ...
                                                    <option value="cart" {{ $coupon->discount_type == 'cart' ? 'selected' : '' }}>Fixed Cart Discount</option>
                                                    <option value="product" {{ $coupon->discount_type == 'product' ? 'selected' : '' }}>Fixed Product Discount</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="text" maxlength="50" class="form-control form-control-modern" name="amount" value="{{ $coupon->amount }}" required />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-5 col-xl-3 control-label text-lg-right pt-2 mt-1 mb-0">Description</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <textarea class="form-control form-control-modern" name="description" rows="4">{{ $coupon->description }}</textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <div class="checkbox">
                                                    ...
                                                    <label class="my-2">
                                                        <input type="checkbox" name="free_shipping" class="checkbox-style-1" value="1" {{ $coupon->free_shipping ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" name="expiry_date" data-plugin-datepicker data-plugin-options='{ "format" : "yyyy-mm-dd" }' value="{{ $coupon->expiry_date }}" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="usage-restriction" role="tabpanel" aria-labelledby="usage-restriction-tab">
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="text" min="0" class="form-control form-control-modern" name="minimum_spend" value="{{ $coupon->minimum_spend }}" placeholder="No minimum" />
                                            </div>
                                        </div>
                                        <div class="form-group row align-items-center">
                                            <label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Maximum Spend <span class="porto-help-tip ml-0" data-toggle="tooltip" title="" data-original-title="Maximum spend (subtotal) allowed to use the coupon."></span></label>
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="text" min="0" class="form-control form-control-modern" name="maximum_spend" value="{{ $coupon->maximum_spend }}" placeholder="No maximum" />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <div class="checkbox">
                                                    ...
                                                    <label class="my-2">
                                                        <input type="checkbox" name="individual_use" class="checkbox-style-1" value="1" {{ $coupon->individual_use ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <div class="checkbox">
                                                    ...
                                                    <label class="my-2">
                                                        <input type="checkbox" name="exclude_sale_items" class="checkbox-style-1" value="1" {{ $coupon->exclude_sale_items ? 'checked' : '' }}>
                                        ...
                                        <div class="form-group row align-items-center">
                                            <label class="col-lg-5 col-xl-3 control-label text-lg-right mb-0">Exclude Categories <span class="porto-help-tip ml-0" data-toggle="tooltip" title="" data-original-title="The product categories that coupon will not be applied"></span></label>
                                            <div class="col-lg-7 col-xl-6">
                                                <select 
                                                    multiple
                                                    data-plugin-selectTwo 
                                        ...
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="text" class="form-control form-control-modern" name="allowed_emails" value="{{ $coupon->allowed_emails }}" placeholder="No restrictions" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="usage-limits" role="tabpanel" aria-labelledby="usage-limits-tab">
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="number" min="0" class="form-control form-control-modern" name="limit_per_coupon" value="{{ $coupon->limit_per_coupon }}" placeholder="Unlimited Usage" />
                                            </div>
                                        </div>
                                        <div class="form-group row align-items-center" id="limit-x-items">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="number" min="0" max="10000" class="form-control form-control-modern" name="limit_x_items" value="{{ $coupon->limit_x_items }}" placeholder="Apply to all qualifying items in cart" />
                                            </div>
                                        </div>
                                        <div class="form-group row align-items-center">
                                            ...
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="number" min="0" max="10000" class="form-control form-control-modern" name="limit_per_user" value="{{ $coupon->limit_per_user }}" placeholder="Unlimited Usage" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="row action-buttons">
            ...
            <div class="col-6 col-md-auto ml-md-auto mt-3 mt-md-0">
                <a href="#" class="delete-button btn btn-danger btn-px-4 py-3 d-flex align-items-center font-weight-semibold line-height-1" data-id="{{ $coupon->id }}">
